...
<div id="badges" align="center">
 ...
 - Это мой первый сайт, написанный на препроцессоре «pug» и «sass», с использованием сторонних библиотек,  а также небольшим javascript кодом для оживления страниц.
